...
function SideCard() {
  return (
    <>
      <div>
        <Card className="min-w-104 h-full">
          
          <CardContent className="px-6">
            {/* ALERTS */}
            <div>
              <CardHeader className="px-6 pl-0 mb-4">
                <CardTitle className="flex items-center gap-5 ">
                  <CircleSmall fill="#EC5967" stroke="none"/>   
                  <span className="text-xl text-[#EC5967] font-extrabold">ALERTS</span>
                </CardTitle>
              </CardHeader>
              <div className="overflow-y-auto h-115 border-b border-border">
            ...
            <div>
              <CardHeader className=" mt-6 pl-0">
                <CardTitle className="flex items-center gap-5 ">
                  ...
                  <span className="text-xl text-[#00D1DE] font-extrabold">NOTIFICATIONS</span>
                </CardTitle>
              </CardHeader>
              <div className="overflow-y-auto h-108 mt-4">
